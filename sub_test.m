...
%      SUB_TEST, by itself, creates a new SUB_TEST or raises the existing
%      singleton*.
%
%      H = SUB_TEST returns the handle to a new SUB_TEST or the handle to
%      the existing singleton*.
%
%      SUB_TEST('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in SUB_TEST.M with the given input arguments.
%
%      SUB_TEST('Property','Value',...) creates a new SUB_TEST or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before sub_test_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to sub_test_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 07-Jan-2022 08:51:26
